...
class MemberController {
    ...
    fun findMemberOfMine(@AuthenticationPrincipal loginMember: LoginMember?): ResponseEntity<LoginMember> {
    ...
    fun showFavorites(@AuthenticationPrincipal loginMember: LoginMember?): ResponseEntity<List<FavoriteResponse>> {
